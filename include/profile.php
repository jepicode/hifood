...
<script>
    ...
    $("#image-user").on("load",function(){
        ...
        var widthimg = $("#image-user")[0].naturalWidth;
        var heightimg = $("#image-user")[0].naturalHeight;
        var height = 100;
        var width = 100;
        if(heightimg < widthimg) {
            $("#photo-author").css("background-size","auto "+height+"px");
        }
        else
            $("#photo-author").css("background-size",width+"px auto");
    });
</script>