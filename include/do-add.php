<?php
    ...
    if(mysql_query("INSERT INTO post VALUES('$id', '$_SESSION[hifood_id]', '$name', '$desc', '$bahan', '$langkah', '$serving', '$time', '$level', '$date', 'recipe')") && mysql_query("INSERT INTO images VALUES('$id_image','post','$id','','$url')")){
